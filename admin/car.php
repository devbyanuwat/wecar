                            ...
                            <td class="align-content-center">
                                <div class="d-flex justify-content-around">
                                    <a href="?q=edit_car&car=<?php echo $row['goods_id']; ?>" class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-box-arrow-right p-1 text-white text-center bg-warning fs-3 rounded-3" viewBox="0 0 16 16">
