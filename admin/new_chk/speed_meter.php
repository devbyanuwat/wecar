<div class="bg-light shadow p-3 pt-3 rounded-3">
    ...
    <div class="row">
        <?php
        $sql_speed_meter = "SELECT * FROM `goods_chk_speed_meter`";
        $result_speed_meter = mysqli_query($conn, $sql_speed_meter);
        $count_speed_meter =  mysqli_num_rows($result_speed_meter);
 
        while ($row_speed_meter = mysqli_fetch_assoc($result_speed_meter)) {
            $chk_id = $row_speed_meter['goods_chk_speed_meter_id'];
        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                if ($id > 0) {
                    ...
                    $sql_speed_meter_value = "SELECT * FROM `chk_speed_meter` WHERE `goods_id` = $id AND `goods_chk_speed_meter_id` = $chk_id";
                    $result_speed_meter_value = mysqli_query($conn, $sql_speed_meter_value);
                    $row_speed_meter_value = mysqli_fetch_assoc($result_speed_meter_value);
 
 
 
                    if ($row_speed_meter_value['goods_chk_status_id'] == 1) {
                ?>
                    ...
                    <?php
                    } else if ($row_speed_meter_value['goods_chk_status_id'] == 2) {
                    ?>
                        <div class="form-check form-check-inline ">
                        ...
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input" type="radio" name="speed_meter_value_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>" id="speed_meter_value_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>" value="2" required checked>
                        </div>
                    <?php
                    }
 
                    $sql_com = "SELECT * FROM `goods_chk_speed_meter_comment` WHERE `goods_id` = $id AND `goods_chk_speed_meter_id` = $chk_id";
                    ...
                    ?>
                        <a style="cursor: pointer;" id="a_speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>" onclick="add_comment('speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>')">
            ...
            <div style="display:block;" class="text-end text-secondary fs-6 " id="c_speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>">
                ...
                <input type='hidden' name='com_speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>' id='com_speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>' value='<?php echo $comm ?>'>
    ...
    <div style="display:none;" class="text-end text-secondary fs-6 " id="c_speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>">
        <span name="speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>" id="speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>">
            <?php echo $comm ?>
        </span>
        <input type='hidden' name='com_speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>' id='com_speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>' value='<?php echo $comm ?>'>
...
<div style="display:none;" class="text-end text-secondary fs-6 " id="c_speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>">
    ...
    <input type='hidden' name='com_speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>' id='com_speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>' value=''>
    <button type="button" class="btn-close" aria-label="Close" onclick="clear_comment('speed_meter_comment_<?php echo $row_speed_meter['goods_chk_speed_meter_id']; ?>')"></button>
</div>
<?php
                }
