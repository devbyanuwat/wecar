        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                ?>
                    ...
                    <?php
                    } else if ($row_windshield_value['goods_chk_status_id'] == 2) {
                    ?>
                        <div class="form-check form-check-inline ">
                        ...
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input" type="radio" name="windshield_value_<?php echo $row_windshield['goods_chk_windshield_id']; ?>" id="windshield_value_<?php echo $row_windshield['goods_chk_windshield_id']; ?>" value="2" required checked>
                        </div>
                    <?php
                    }
            ...
            <div style="display:block;" class="text-end text-secondary fs-6 " id="c_windshield_comment_<?php echo $row_windshield['goods_chk_windshield_id']; ?>">
                ...
                <input type='hidden' name='com_windshield_comment_<?php echo $row_windshield['goods_chk_windshield_id']; ?>' id='com_windshield_comment_<?php echo $row_windshield['goods_chk_windshield_id']; ?>' value='<?php echo $comm ?>'>
