            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                ?>
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input" type="radio" name="front_light_value_<?php echo $row_front_light['goods_chk_front_light_id']; ?>" id="front_light_value_<?php echo $row_front_light['goods_chk_front_light_id']; ?>" value="1" required checked>
                        </div>
                        <div class="form-check form-check-inline ">
                    ...
                    <?php
                    } else if ($row_front_light_value['goods_chk_status_id'] == 2) {
                    ?>
                        <div class="form-check form-check-inline ">
                        ...
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input" type="radio" name="front_light_value_<?php echo $row_front_light['goods_chk_front_light_id']; ?>" id="front_light_value_<?php echo $row_front_light['goods_chk_front_light_id']; ?>" value="2" required checked>
                        </div>
                    <?php
                    }
