<div class="bg-light shadow p-3 pt-3 rounded-3">
    ...
    <div class="row">
        <?php
        $sql_shock_absorber = "SELECT * FROM `goods_chk_shock_absorber`";
        $result_shock_absorber = mysqli_query($conn, $sql_shock_absorber);
        $count_shock_absorber =  mysqli_num_rows($result_shock_absorber);
 
        while ($row_shock_absorber = mysqli_fetch_assoc($result_shock_absorber)) {
            $chk_id = $row_shock_absorber['goods_chk_shock_absorber_id'];
        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                if ($id > 0) {
                    ...
                    $sql_shock_absorber_value = "SELECT * FROM `chk_shock_absorber` WHERE `goods_id` = $id AND `goods_chk_shock_absorber_id` = $chk_id";
                    $result_shock_absorber_value = mysqli_query($conn, $sql_shock_absorber_value);
                    $row_shock_absorber_value = mysqli_fetch_assoc($result_shock_absorber_value);
 
 
 
                    if ($row_shock_absorber_value['goods_chk_status_id'] == 1) {
                ?>
                    ...
                    <?php
                    } else if ($row_shock_absorber_value['goods_chk_status_id'] == 2) {
                    ?>
                        <div class="form-check form-check-inline ">
                        ...
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input" type="radio" name="shock_absorber_value_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>" id="shock_absorber_value_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>" value="2" required checked>
                        </div>
                    <?php
                    }
 
                    $sql_com = "SELECT * FROM `goods_chk_shock_absorber_comment` WHERE `goods_id` = $id AND `goods_chk_shock_absorber_id` = $chk_id";
                    ...
                    ?>
                        <a style="cursor: pointer;" id="a_shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>" onclick="add_comment('shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>')">
            ...
            <div style="display:block;" class="text-end text-secondary fs-6 " id="c_shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>">
                ...
                <input type='hidden' name='com_shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>' id='com_shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>' value='<?php echo $comm ?>'>
    ...
    <div style="display:none;" class="text-end text-secondary fs-6 " id="c_shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>">
        <span name="shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>" id="shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>">
            <?php echo $comm ?>
        </span>
        <input type='hidden' name='com_shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>' id='com_shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>' value='<?php echo $comm ?>'>
...
<div style="display:none;" class="text-end text-secondary fs-6 " id="c_shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>">
    ...
    <input type='hidden' name='com_shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>' id='com_shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>' value=''>
    <button type="button" class="btn-close" aria-label="Close" onclick="clear_comment('shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>')"></button>
</div>
<?php
                }
