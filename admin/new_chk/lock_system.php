<div class="bg-light shadow p-3 pt-3 rounded-3">
    ...
    <div class="row">
        ...
        while ($row_lock_system = mysqli_fetch_assoc($result_lock_system)) {
            $chk_id = $row_lock_system['goods_chk_lock_system_id'];
        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                if ($id > 0) {
                    ...
                    $sql_lock_system_value = "SELECT * FROM `chk_lock_system` WHERE `goods_id` = $id AND `goods_chk_lock_system_id` = $chk_id";
                    $result_lock_system_value = mysqli_query($conn, $sql_lock_system_value);
                    $row_lock_system_value = mysqli_fetch_assoc($result_lock_system_value);
 
 
 
                    if ($row_lock_system_value['goods_chk_status_id'] == 1) {
                ?>
                    ...
                    <?php
                    } else if ($row_lock_system_value['goods_chk_status_id'] == 2) {
                    ?>
                        <div class="form-check form-check-inline ">
                        ...
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input" type="radio" name="lock_system_value_<?php echo $row_lock_system['goods_chk_lock_system_id']; ?>" id="lock_system_value_<?php echo $row_lock_system['goods_chk_lock_system_id']; ?>" value="2" required checked>
                        </div>
                    <?php
                    }
 
                    $sql_com = "SELECT * FROM `goods_chk_lock_system_comment` WHERE `goods_id` = $id AND `goods_chk_lock_system_id` = $chk_id";
                    ...
                    ?>
                        <a style="cursor: pointer;" id="a_lock_system_comment_<?php echo $row_lock_system['goods_chk_lock_system_id']; ?>" onclick="add_comment('lock_system_comment_<?php echo $row_lock_system['goods_chk_lock_system_id']; ?>')">
            ...
            <div style="display:block;" class="text-end text-secondary fs-6 " id="c_lock_system_comment_<?php echo $row_lock_system['goods_chk_lock_system_id']; ?>">
                ...
                <input type='hidden' name='com_lock_system_comment_<?php echo $row_lock_system['goods_chk_lock_system_id']; ?>' id='com_lock_system_comment_<?php echo $row_lock_system['goods_chk_lock_system_id']; ?>' value='<?php echo $comm ?>'>
...
<div style="display:none;" class="text-end text-secondary fs-6 " id="c_lock_system_comment_<?php echo $row_lock_system['goods_chk_lock_system_id']; ?>">
    ...
    <input type='hidden' name='com_lock_system_comment_<?php echo $row_lock_system['goods_chk_lock_system_id']; ?>' id='com_lock_system_comment_<?php echo $row_lock_system['goods_chk_lock_system_id']; ?>' value=''>
    <button type="button" class="btn-close" aria-label="Close" onclick="clear_comment('lock_system_comment_<?php echo $row_lock_system['goods_chk_lock_system_id']; ?>')"></button>
</div>
<?php
                }
