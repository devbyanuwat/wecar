        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                ?>
                    ...
                    $sql_com = "SELECT * FROM `goods_chk_window_glass_comment` WHERE `goods_id` = $id AND `goods_chk_window_glass_id` = $chk_id";
            ...
            <div style="display:block;" class="text-end text-secondary fs-6 " id="c_window_glass_comment_<?php echo $row_window_glass['goods_chk_window_glass_id']; ?>">
                ...
                <input type='hidden' name='com_window_glass_comment_<?php echo $row_window_glass['goods_chk_window_glass_id']; ?>' id='com_window_glass_comment_<?php echo $row_window_glass['goods_chk_window_glass_id']; ?>' value='<?php echo $comm ?>'>
