<div class="bg-light shadow p-3 pt-3 rounded-3">
    ...
    <div class="row">
        ...
        while ($row_handrail = mysqli_fetch_assoc($result_handrail)) {
            $chk_id = $row_handrail['goods_chk_handrail_id'];
 
        ?>
 
            <div class="<?php echo $detail; ?>">
                <div class="row">
                    <input type="hidden" name="handrail_id_<?php echo $row_handrail['goods_chk_handrail_id']; ?>" id="handrail_id_<?php echo $row_handrail['goods_chk_handrail_id']; ?>" value="<?php echo $row_handrail['goods_chk_handrail_id']; ?>">
            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                if ($id > 0) {
                    ...
                    $sql_handrail_value = "SELECT * FROM `chk_handrail` WHERE `goods_id` = $id AND `goods_chk_handrail_id` = $chk_id";
                    $result_handrail_value = mysqli_query($conn, $sql_handrail_value);
                    $row_handrail_value = mysqli_fetch_assoc($result_handrail_value);
 
 
 
                    if ($row_handrail_value['goods_chk_status_id'] == 1) {
                ?>
                    ...
                    <?php
                    } else if ($row_handrail_value['goods_chk_status_id'] == 2) {
                    ?>
                        <div class="form-check form-check-inline ">
                        ...
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input" type="radio" name="handrail_value_<?php echo $row_handrail['goods_chk_handrail_id']; ?>" id="handrail_value_<?php echo $row_handrail['goods_chk_handrail_id']; ?>" value="2" required checked>
                        </div>
                    <?php
                    }
 
                    $sql_com = "SELECT * FROM `goods_chk_handrail_comment` WHERE `goods_id` = $id AND `goods_chk_handrail_id` = $chk_id";
                    ...
                    ?>
                        <a style="cursor: pointer;" id="a_handrail_comment_<?php echo $row_handrail['goods_chk_handrail_id']; ?>" onclick="add_comment('handrail_comment_<?php echo $row_handrail['goods_chk_handrail_id']; ?>')">
            ...
            <div style="display:block;" class="text-end text-secondary fs-6 " id="c_handrail_comment_<?php echo $row_handrail['goods_chk_handrail_id']; ?>">
                ...
                <input type='hidden' name='com_handrail_comment_<?php echo $row_handrail['goods_chk_handrail_id']; ?>' id='com_handrail_comment_<?php echo $row_handrail['goods_chk_handrail_id']; ?>' value='<?php echo $comm ?>'>
...
<div style="display:none;" class="text-end text-secondary fs-6 " id="c_handrail_comment_<?php echo $row_handrail['goods_chk_handrail_id']; ?>">
    ...
    <input type='hidden' name='com_handrail_comment_<?php echo $row_handrail['goods_chk_handrail_id']; ?>' id='com_handrail_comment_<?php echo $row_handrail['goods_chk_handrail_id']; ?>' value=''>
    <button type="button" class="btn-close" aria-label="Close" onclick="clear_comment('handrail_comment_<?php echo $row_handrail['goods_chk_handrail_id']; ?>')"></button>
</div>
<?php
                }
