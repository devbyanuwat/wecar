    ...
    <div class="row">
        ...
        ?>
            <div class="<?php echo $detail; ?>">
                <div class="row">
                    <input type="hidden" name="entertainment_control_system_id_<?php echo $row_front_light['goods_chk_front_light_id']; ?>" id="entertainment_control_system_id_<?php echo $row_entertainment_control_system['goods_chk_entertainment_control_system_id']; ?>" value="<?php echo $row_front_light['goods_chk_front_light_id']; ?>">
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="entertainment_control_system_value_<?php echo $row_entertainment_control_system['goods_chk_entertainment_control_system_id']; ?>" id="entertainment_control_system_name_<?php echo $row_entertainment_control_system['goods_chk_entertainment_control_system_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="entertainment_control_system_value_<?php echo $row_entertainment_control_system['goods_chk_entertainment_control_system_id']; ?>" id="entertainment_control_system_name_<?php echo $row_entertainment_control_system['goods_chk_entertainment_control_system_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_entertainment_control_system_comment_<?php echo $row_entertainment_control_system['goods_chk_entertainment_control_system_id']; ?>" onclick="add_comment('entertainment_control_system_comment_<?php echo $row_entertainment_control_system['goods_chk_entertainment_control_system_id']; ?>')" disabled>
