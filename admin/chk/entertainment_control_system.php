        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                ?>
                    ...
                    $sql_com = "SELECT * FROM `goods_chk_entertainment_control_system_comment` WHERE `goods_id` = $id AND `goods_chk_entertainment_control_system_id` = $chk_id";
            ...
            <div style="display:block;" class="text-end text-secondary fs-6 " id="c_entertainment_control_system_comment_<?php echo $row_entertainment_control_system['goods_chk_entertainment_control_system_id']; ?>">
                ...
                <input type='hidden' name='com_entertainment_control_system_comment_<?php echo $row_entertainment_control_system['goods_chk_entertainment_control_system_id']; ?>' id='com_entertainment_control_system_comment_<?php echo $row_entertainment_control_system['goods_chk_entertainment_control_system_id']; ?>' value='<?php echo $comm ?>'>
