<div class="bg-light shadow p-3 pt-3 rounded-3">
    ...
    <div class="row">
        ...
        while ($row_powertrain = mysqli_fetch_assoc($result_powertrain)) {
            $chk_id = $row_powertrain['goods_chk_powertrain_id'];
 
        ?>
 
            <div class="<?php echo $detail; ?>">
                <div class="row">
                    <input type="hidden" name="powertrain_id_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>" id="powertrain_id_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>" value="<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>">
            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                if ($id > 0) {
                    ...
                    $sql_powertrain_value = "SELECT * FROM `chk_powertrain` WHERE `goods_id` = $id AND `goods_chk_powertrain_id` = $chk_id";
                    $result_powertrain_value = mysqli_query($conn, $sql_powertrain_value);
                    $row_powertrain_value = mysqli_fetch_assoc($result_powertrain_value);
 
 
 
                    if ($row_powertrain_value['goods_chk_status_id'] == 1) {
                ?>
                    ...
                    <?php
                    } else if ($row_powertrain_value['goods_chk_status_id'] == 2) {
                    ?>
                        <div class="form-check form-check-inline ">
                        ...
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input" type="radio" name="powertrain_value_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>" id="powertrain_value_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>" value="2" required checked>
                        </div>
                    <?php
                    }
 
                    $sql_com = "SELECT * FROM `goods_chk_powertrain_comment` WHERE `goods_id` = $id AND `goods_chk_powertrain_id` = $chk_id";
                    ...
                    ?>
                        <a style="cursor: pointer;" id="a_powertrain_comment_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>" onclick="add_comment('powertrain_comment_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>')">
            ...
            <div style="display:block;" class="text-end text-secondary fs-6 " id="c_powertrain_comment_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>">
                ...
                <input type='hidden' name='com_powertrain_comment_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>' id='com_powertrain_comment_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>' value='<?php echo $comm ?>'>
...
<div style="display:none;" class="text-end text-secondary fs-6 " id="c_powertrain_comment_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>">
    ...
    <input type='hidden' name='com_powertrain_comment_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>' id='com_powertrain_comment_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>' value=''>
    <button type="button" class="btn-close" aria-label="Close" onclick="clear_comment('powertrain_comment_<?php echo $row_powertrain['goods_chk_powertrain_id']; ?>')"></button>
</div>
<?php
                }
