        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="window_film_value_<?php echo $row_window_film['goods_chk_window_film_id']; ?>" id="window_film_name_<?php echo $row_window_film['goods_chk_window_film_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="window_film_value_<?php echo $row_window_film['goods_chk_window_film_id']; ?>" id="window_film_name_<?php echo $row_window_film['goods_chk_window_film_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_window_film_comment_<?php echo $row_window_film['goods_chk_window_film_id']; ?>" onclick="add_comment('window_film_comment_<?php echo $row_window_film['goods_chk_window_film_id']; ?>')" disabled>
