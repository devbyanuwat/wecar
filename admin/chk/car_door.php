        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="car_door_value_<?php echo $row_car_door['goods_chk_car_door_id']; ?>" id="car_door_name_<?php echo $row_car_door['goods_chk_car_door_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="car_door_value_<?php echo $row_car_door['goods_chk_car_door_id']; ?>" id="car_door_name_<?php echo $row_car_door['goods_chk_car_door_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_car_door_comment_<?php echo $row_car_door['goods_chk_car_door_id']; ?>" onclick="add_comment('car_door_comment_<?php echo $row_car_door['goods_chk_car_door_id']; ?>')" disabled>
