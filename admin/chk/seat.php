    ...
    <div class="row">
        ...
        ?>
            <div class="<?php echo $detail; ?>">
                <div class="row">
                    <input type="hidden" name="seat_id_<?php echo $row_front_light['goods_chk_front_light_id']; ?>" id="seat_id_<?php echo $row_seat['goods_chk_seat_id']; ?>" value="<?php echo $row_front_light['goods_chk_front_light_id']; ?>">
