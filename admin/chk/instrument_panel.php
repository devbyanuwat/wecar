        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="instrument_panel_value_<?php echo $row_instrument_panel['goods_chk_instrument_panel_id']; ?>" id="instrument_panel_name_<?php echo $row_instrument_panel['goods_chk_instrument_panel_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="instrument_panel_value_<?php echo $row_instrument_panel['goods_chk_instrument_panel_id']; ?>" id="instrument_panel_name_<?php echo $row_instrument_panel['goods_chk_instrument_panel_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_instrument_panel_comment_<?php echo $row_instrument_panel['goods_chk_instrument_panel_id']; ?>" onclick="add_comment('instrument_panel_comment_<?php echo $row_instrument_panel['goods_chk_instrument_panel_id']; ?>')" disabled>
