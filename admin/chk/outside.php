<div class="bg-light shadow p-3 pt-3 rounded-3">
        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                ?>
                    ...
                    $sql_com = "SELECT * FROM `goods_chk_outside_comment` WHERE `goods_id` = $id AND `goods_chk_outside_id` = $chk_id";
            ...
            <div style="display:block;" class="text-end text-secondary fs-6 " id="c_outside_comment_<?php echo $row_outside['goods_chk_outside_id']; ?>">
                ...
                <input type='hidden' name='com_outside_comment_<?php echo $row_outside['goods_chk_outside_id']; ?>' id='com_outside_comment_<?php echo $row_outside['goods_chk_outside_id']; ?>' value='<?php echo $comm ?>'>
    ...
    <div style="display:none;" class="text-end text-secondary fs-6 " id="c_outside_comment_<?php echo $row_outside['goods_chk_outside_id']; ?>">
        <span name="outside_comment_<?php echo $row_outside['goods_chk_outside_id']; ?>" id="outside_comment_<?php echo $row_outside['goods_chk_outside_id']; ?>">
            <?php echo $comm ?>
        </span>
        <input type='hidden' name='com_outside_comment_<?php echo $row_outside['goods_chk_outside_id']; ?>' id='com_outside_comment_<?php echo $row_outside['goods_chk_outside_id']; ?>' value='<?php echo $comm ?>'>
