    ...
    <div class="row">
        ...
        ?>
            <div class="<?php echo $detail; ?>">
                <div class="row">
                    <input type="hidden" name="engine_and_gear_id_<?php echo $row_front_light['goods_chk_front_light_id']; ?>" id="engine_and_gear_id_<?php echo $row_engine_and_gear['goods_chk_engine_and_gear_id']; ?>" value="<?php echo $row_front_light['goods_chk_front_light_id']; ?>">
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="engine_and_gear_value_<?php echo $row_engine_and_gear['goods_chk_engine_and_gear_id']; ?>" id="engine_and_gear_name_<?php echo $row_engine_and_gear['goods_chk_engine_and_gear_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="engine_and_gear_value_<?php echo $row_engine_and_gear['goods_chk_engine_and_gear_id']; ?>" id="engine_and_gear_name_<?php echo $row_engine_and_gear['goods_chk_engine_and_gear_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_engine_and_gear_comment_<?php echo $row_engine_and_gear['goods_chk_engine_and_gear_id']; ?>" onclick="add_comment('engine_and_gear_comment_<?php echo $row_engine_and_gear['goods_chk_engine_and_gear_id']; ?>')" disabled>
