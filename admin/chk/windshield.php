    ...
    <div class="row">
        ...
        ?>
            <div class="<?php echo $detail; ?>">
                <div class="row">
                    <input type="hidden" name="windshield_id_<?php echo $row_front_light['goods_chk_front_light_id']; ?>" id="windshield_id_<?php echo $row_windshield['goods_chk_windshield_id']; ?>" value="<?php echo $row_front_light['goods_chk_front_light_id']; ?>">
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="windshield_value_<?php echo $row_windshield['goods_chk_windshield_id']; ?>" id="windshield_name_<?php echo $row_windshield['goods_chk_windshield_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="windshield_value_<?php echo $row_windshield['goods_chk_windshield_id']; ?>" id="windshield_name_<?php echo $row_windshield['goods_chk_windshield_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_windshield_comment_<?php echo $row_windshield['goods_chk_windshield_id']; ?>" onclick="add_comment('windshield_comment_<?php echo $row_windshield['goods_chk_windshield_id']; ?>')" disabled>
            ...
            <div style="display:none;" class="text-end text-secondary fs-6 " id="c_windshield_comment_<?php echo $row_windshield['goods_chk_windshield_id']; ?>">
