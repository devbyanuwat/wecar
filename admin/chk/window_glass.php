    ...
    <div class="row">
        ...
        ?>
            <div class="<?php echo $detail; ?>">
                <div class="row">
                    <input type="hidden" name="window_glass_id_<?php echo $row_front_light['goods_chk_front_light_id']; ?>" id="window_glass_id_<?php echo $row_window_glass['goods_chk_window_glass_id']; ?>" value="<?php echo $row_front_light['goods_chk_front_light_id']; ?>">
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="window_glass_value_<?php echo $row_window_glass['goods_chk_window_glass_id']; ?>" id="window_glass_name_<?php echo $row_window_glass['goods_chk_window_glass_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="window_glass_value_<?php echo $row_window_glass['goods_chk_window_glass_id']; ?>" id="window_glass_name_<?php echo $row_window_glass['goods_chk_window_glass_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_window_glass_comment_<?php echo $row_window_glass['goods_chk_window_glass_id']; ?>" onclick="add_comment('window_glass_comment_<?php echo $row_window_glass['goods_chk_window_glass_id']; ?>')" disabled>
