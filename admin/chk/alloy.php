        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="alloy_value_<?php echo $row_alloy['goods_chk_alloy_id']; ?>" id="alloy_name_<?php echo $row_alloy['goods_chk_alloy_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="alloy_value_<?php echo $row_alloy['goods_chk_alloy_id']; ?>" id="alloy_name_<?php echo $row_alloy['goods_chk_alloy_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_alloy_comment_<?php echo $row_alloy['goods_chk_alloy_id']; ?>" onclick="add_comment('alloy_comment_<?php echo $row_alloy['goods_chk_alloy_id']; ?>')" disabled>
