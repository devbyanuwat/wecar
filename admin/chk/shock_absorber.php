        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="shock_absorber_value_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>" id="shock_absorber_name_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="shock_absorber_value_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>" id="shock_absorber_name_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>" onclick="add_comment('shock_absorber_comment_<?php echo $row_shock_absorber['goods_chk_shock_absorber_id']; ?>')" disabled>
