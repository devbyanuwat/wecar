<div class="bg-light shadow p-3 pt-3 rounded-3">
    ...
    <div class="row">
        ...
        while ($row_side_mirror = mysqli_fetch_assoc($result_side_mirror)) {
            $chk_id = $row_side_mirror['goods_chk_side_mirror_id'];
        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                if ($id > 0) {
                    ...
                    $sql_side_mirror_value = "SELECT * FROM `chk_side_mirror` WHERE `goods_id` = $id AND `goods_chk_side_mirror_id` = $chk_id";
                    $result_side_mirror_value = mysqli_query($conn, $sql_side_mirror_value);
                    $row_side_mirror_value = mysqli_fetch_assoc($result_side_mirror_value);
 
 
 
                    if ($row_side_mirror_value['goods_chk_status_id'] == 1) {
                ?>
                    ...
                    <?php
                    } else if ($row_side_mirror_value['goods_chk_status_id'] == 2) {
                    ?>
                        <div class="form-check form-check-inline ">
                        ...
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input" type="radio" name="side_mirror_value_<?php echo $row_side_mirror['goods_chk_side_mirror_id']; ?>" id="side_mirror_value_<?php echo $row_side_mirror['goods_chk_side_mirror_id']; ?>" value="2" required checked>
                        </div>
                    <?php
                    }
 
                    $sql_com = "SELECT * FROM `goods_chk_side_mirror_comment` WHERE `goods_id` = $id AND `goods_chk_side_mirror_id` = $chk_id";
                    ...
                    ?>
                        <a style="cursor: pointer;" id="a_side_mirror_comment_<?php echo $row_side_mirror['goods_chk_side_mirror_id']; ?>" onclick="add_comment('side_mirror_comment_<?php echo $row_side_mirror['goods_chk_side_mirror_id']; ?>')">
            ...
            <div style="display:block;" class="text-end text-secondary fs-6 " id="c_side_mirror_comment_<?php echo $row_side_mirror['goods_chk_side_mirror_id']; ?>">
                ...
                <input type='hidden' name='com_side_mirror_comment_<?php echo $row_side_mirror['goods_chk_side_mirror_id']; ?>' id='com_side_mirror_comment_<?php echo $row_side_mirror['goods_chk_side_mirror_id']; ?>' value='<?php echo $comm ?>'>
...
<div style="display:none;" class="text-end text-secondary fs-6 " id="c_side_mirror_comment_<?php echo $row_side_mirror['goods_chk_side_mirror_id']; ?>">
    ...
    <input type='hidden' name='com_side_mirror_comment_<?php echo $row_side_mirror['goods_chk_side_mirror_id']; ?>' id='com_side_mirror_comment_<?php echo $row_side_mirror['goods_chk_side_mirror_id']; ?>' value=''>
    <button type="button" class="btn-close" aria-label="Close" onclick="clear_comment('side_mirror_comment_<?php echo $row_side_mirror['goods_chk_side_mirror_id']; ?>')"></button>
</div>
<?php
                }
