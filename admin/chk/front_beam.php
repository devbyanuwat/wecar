<div class="bg-light shadow p-3 pt-3 rounded-3">
    ...
    <div class="row">
        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="front_beam_value_<?php echo $row_front_beam['goods_chk_front_beam_id']; ?>" id="front_beam_name_<?php echo $row_front_beam['goods_chk_front_beam_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="front_beam_value_<?php echo $row_front_beam['goods_chk_front_beam_id']; ?>" id="front_beam_name_<?php echo $row_front_beam['goods_chk_front_beam_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_front_beam_comment_<?php echo $row_front_beam['goods_chk_front_beam_id']; ?>" onclick="add_comment('front_beam_comment_<?php echo $row_front_beam['goods_chk_front_beam_id']; ?>')" disabled>
        ...
        <?php } ?>
        <input type="hidden" name="count_front_light" id="count_front_light" value="<?php echo $count_front_beam; ?>">
    </div>
</div>