        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                ...
                ?>
                    ...
                    $sql_com = "SELECT * FROM `goods_chk_front_beam_comment` WHERE `goods_id` = $id AND `goods_chk_front_beam_id` = $chk_id";
            ...
            <div style="display:block;" class="text-end text-secondary fs-6 " id="c_front_beam_comment_<?php echo $row_front_beam['goods_chk_front_beam_id']; ?>">
                ...
                <input type='hidden' name='com_front_beam_comment_<?php echo $row_front_beam['goods_chk_front_beam_id']; ?>' id='com_front_beam_comment_<?php echo $row_front_beam['goods_chk_front_beam_id']; ?>' value='<?php echo $comm ?>'>
