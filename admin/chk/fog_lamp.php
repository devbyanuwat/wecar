        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="fog_lamp_value_<?php echo $row_fog_lamp['goods_chk_fog_lamp_id']; ?>" id="fog_lamp_name_<?php echo $row_fog_lamp['goods_chk_fog_lamp_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="fog_lamp_value_<?php echo $row_fog_lamp['goods_chk_fog_lamp_id']; ?>" id="fog_lamp_name_<?php echo $row_fog_lamp['goods_chk_fog_lamp_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_fog_lamp_comment_<?php echo $row_fog_lamp['goods_chk_fog_lamp_id']; ?>" onclick="add_comment('fog_lamp_comment_<?php echo $row_fog_lamp['goods_chk_fog_lamp_id']; ?>')" disabled>
