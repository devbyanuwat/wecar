<div class="bg-light shadow p-3 pt-3 rounded-3">
    ...
    <div class="row">
        ...
        ?>
            ...
            <div class="col-5 d-flex justify-content-between ">
                <div class="form-check form-check-inline ">
                    <input class="form-check-input" type="radio" name="car_floor_value_<?php echo $row_car_floor['goods_chk_car_floor_id']; ?>" id="car_floor_name_<?php echo $row_car_floor['goods_chk_car_floor_id'] ?>" value="1" required>
                </div>
                <div class="form-check form-check-inline ">
                    <input class="form-check-input " type="radio" name="car_floor_value_<?php echo $row_car_floor['goods_chk_car_floor_id']; ?>" id="car_floor_name_<?php echo $row_car_floor['goods_chk_car_floor_id']; ?>" value="2" required>
                </div>
                <a style="cursor: pointer ;" id="a_car_floor_comment_<?php echo $row_car_floor['goods_chk_car_floor_id']; ?>" onclick="add_comment('car_floor_comment_<?php echo $row_car_floor['goods_chk_car_floor_id']; ?>')" disabled>
        ...
        <?php } ?>
        <input type="hidden" name="count_front_light" id="count_front_light" value="<?php echo $count_car_floor; ?>">
    </div>
</div>