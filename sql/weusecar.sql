...
--
-- Host: localhost
-- Generation Time: Jul 19, 2022 at 02:10 PM
...
INSERT INTO `goods` (`goods_id`, `goods_name`, `goods_machine`, `goods_gear`, `goods_mileage`, `goods_petroleum`, `goods_price`, `goods_img`, `goods_status`) VALUES
(1, '2018 Mitsubishi Pajero-Sport', '2.4 Gls Limited', 'เกียร์อัตโนมัติ', '54,773 ', 'ดีเซล', '841,100 บาท', 'Pajero_sport.png', 0),
(5, 'CAMRY', '-', '-', '-', '-', '999', 'Pajero_sport.png', 0),
(6, 'CAMRY', '-', '-', '-', '-', '999', 'Pajero_sport.png', 0),
(7, 'CAMRY', '-', '-', '-', '-', '999', 'Pajero_sport.png', 0),
(8, 'CAMRY', '-', '-', '-', '-', '999', 'Pajero_sport.png', 0),
(9, 'ACCORD', '-', '-', '-', '-', '999', 'Pajero_sport.png', 0),
(10, 'ACCORD', '-', '-', '-', '-', '999', 'Pajero_sport.png', 0),
(11, 'CIVIC', '-', '-', '-', '-', '1212', 'Pajero_sport.png', 0),
(12, 'CIVIC', '-', '-', '-', '-', '1212', 'Pajero_sport.png', 0),
(13, 'CIVIC', '-', '-', '-', '-', '1212', 'Pajero_sport.png', 0),
(14, 'CIVIC', '-', '-', '-', '-', '1212', 'Pajero_sport.png', 0),
(15, 'CIVIC', '-', '-', '-', '-', '1212', 'Pajero_sport.png', 0),
(16, 'CIVIC', '-', '-', '-', '-', '1212', 'Pajero_sport.png', 0),
(17, 'CIVIC', '-', '-', '-', '-', '1212', 'Pajero_sport.png', 0),
(18, 'CIVIC', '-', '-', '-', '-', '1212', 'Pajero_sport.png', 0),
(19, 'CIVIC', '-', '-', '-', '-', '1212', 'Pajero_sport.png', 0),
(20, 'CITY', '-', '-', '-', '-', '123', 'Pajero_sport.png', 0),
(21, '', '-', '-', '-', '-', '123', 'Pajero_sport.png', 0),
(22, '', '-', '-', '-', '-', '123', 'Pajero_sport.png', 0),
(23, '', '-', '-', '-', '-', '123', 'Pajero_sport.png', 0),
(24, '', '-', '-', '-', '-', '123', 'Pajero_sport.png', 0),
(25, '', '-', '-', '-', '-', '123', 'Pajero_sport.png', 0),
(26, '', '-', '-', '-', '-', '123', 'Pajero_sport.png', 0),
(27, '', '-', '-', '-', '-', '123', 'Pajero_sport.png', 0),
(28, '', '-', '-', '-', '-', '123', 'Pajero_sport.png', 0);
...
--
ALTER TABLE `goods`
  MODIFY `goods_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `goods_img`
  MODIFY `goods_img_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
